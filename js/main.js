var outerWidth = 1200;
var outerHeight = 800;
var margin = {left: 200, top: 150, right: 100, bottom: 150};
...
.html(function(d){
  ...
  .attr('y', (innerHeight + margin.bottom/1.5) - 10)
  .text(function(d){
    return (d.toFixed(1));
  })
...
$.getJSON('https://raw.githubusercontent.com/FreeCodeCamp/ProjectReferenceData/master/global-temperature.json', function(d){
  render(d.monthlyVariance, d.baseTemperature);
});
